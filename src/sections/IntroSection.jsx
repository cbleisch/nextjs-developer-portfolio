    ...
    >
      ...
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            <div>
              <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl md:text-left border-b border-b-slate-200 dark:border-b-gray-600 w-fit">
                Charlie Bleisch
              </h1>
              <div className="mt-6 text-2xl leading-8 text-fore-primary sm:text-center md:text-left">
              ...
              <div className="mt-8 flex gap-x-4 sm:justify-center ">
                <Link href="#" className="px-4 py-1.5 flex text-white text-xl font-semibold leading-7 shadow-sm hover:text-orange-500 hover:underline"> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-7 h-7 fill-white mr-2 hover:fill-inherit hover:underline-inherit">
